_ace_settings = [ 
	...
	["ace_medical_enableUnconsciousnessAI", 0], /*AI unconsciousness (0 = disabled, 2 = enabled, 1 =  50/50?*/
	...
	["ace_medical_enableFor", 0], /*enable for players/players and AI (players: 0, players and AI: 1)*/
	...
	/*Revive*/
	["ace_medical_enableRevive", 0], /*Enable (0 = disable, 1 = players, 2 = players&AI)*/
	...
	/*Captives*/
	["ace_captives_allowHandcuffOwnSide", false], /*Can handcuff own side*/
