...
_intel = ["Diary", "Intel", "blu_intel.txt"] call caran_briefingFile;
_mission = ["Diary", "Mission", "blu_mission.txt"] call caran_briefingFile;
_situation = ["Diary", "Situation", "blu_situation.txt"] call caran_briefingFile;